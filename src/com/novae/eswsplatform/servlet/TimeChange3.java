 ...
 */
@WebServlet("/TimeChange3")
public class TimeChange3 extends HttpServlet {
...
//		Timestamp endTime = new Timestamp(endYear - 1900, endMonth, endDay, endHour, endMinute, startSecond, 0);
		...
		this.tempSystemTimeBean.setId(3);
		
		this.adminService.changeTime(3, this.tempSystemTimeBean);
