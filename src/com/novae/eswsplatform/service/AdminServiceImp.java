...
public class AdminServiceImp implements AdminService {
	 ...
	 * @return 推荐单位
	 */
	public ReferBean getRefersByID(int id) {
	...
	public void changePreResult(int ID , boolean result) {
		...
		if (declarerBean.getId()==ID) {
			declarerBean.setPreJugdeRes(result);
			System.out.println("修改了"+declarerBean.getId());
		}
		declarerBeanDAO.attachDirty(declarerBean);
	}
	 ...
	 */
	@Override
	public List<DeclarerBean> getPreCandidatesInGroup(int id) {
		List<DeclarerBean> list = (List<DeclarerBean>)declarerBeanDAO.findAll();
		List<DeclarerBean> ans = new ArrayList<DeclarerBean>();
		for (DeclarerBean d: list){
			if (d.getGroupId()==id) {
	...
	/**获取指定学科组内所有初评没通过的人
	 * @param id 学科组ID
	 * @return 学科组内所有初评妹通过的人
	 */
	@Override
	public List<DeclarerBean> getNPreCandidatesInGroup(int id) {
		List<DeclarerBean> list = (List<DeclarerBean>)declarerBeanDAO.findAll();
		List<DeclarerBean> ans = new ArrayList<DeclarerBean>();
		for (DeclarerBean d: list){
			if (d.getGroupId()==id) {
	...
	/**获取指定学科组中的未通过申报者
	 * @param ID 学科组ID
	 * @return 制定学科组中的所有未通过申报者
	 */
	@Override
	public List<DeclarerBean> getNCandidatesInGroup(int ID) {
		List<DeclarerBean> ans = new ArrayList<DeclarerBean>();
		List<DeclarerBean> list = (List<DeclarerBean>)declarerBeanDAO.findAll();
		for (DeclarerBean d: list){
			if ( d.getGroupId() == ID ) {
