...
public interface AdminService {
	 ...
	 * @return 推荐单位
	 */
	ReferBean getRefersByID(int id); 
	 ...
	 */
	List<DeclarerBean> getNCandidatesInGroup(int ID);
	 ...
	 * @return 学科组内所有初评通过的人
	 */
	List<DeclarerBean> getPreCandidatesInGroup(int id);

	/**获取指定学科组内所有初评没通过的人
	 * @param id 学科组ID
	 * @return 学科组内所有初评妹通过的人
	 */
	List<DeclarerBean> getNPreCandidatesInGroup(int id);	
}
