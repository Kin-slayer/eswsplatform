...
<title>My JSP 'canList.jsp' starting page</title>
...
List<DeclarerBean> allCandidates = adminService.getCandidates();
%>
	...
	<table width="98%" border="1" class="maintable">
		<tr>
			...
			<td width="82%" align="center" valign="top">
				<div class="subtitle">辽宁省科学技术协会-候选人名单</div>
				...
				<div class="secondtable">
					<form action="abc" method="get" name="canFirstRtAdmin">
						...
						<table width="95%" border="1"
							...
							<tr>
								<td colspan="7">已入选名单</td>
							</tr>
							<tr>
								<td width="5%">选择</td>
								<td width="10%">序号</td>
								<td width="20%">候选人姓名</td>
								<td width="20%">学科组</td>
								<td width="20%">学科类别</td>
								<td width="10%">详情</td>
								<td width="15%">&nbsp;</td>
							...
							<tr>
								...
								<td>123</td>
								<td>123</td>
								<td><input type="submit" name="detail" id="detail"
									value="查看详情" /></td>
								<td><input name="change" type="button" value="修改" /><input
									name="delete" type="button" value="删除" /></td>
							</tr>
						</table>

						<table width="95%" border="1" style="float:left">
							<tr>
								<td colspan="7">未入选名单</td>
							</tr>
							<tr>
								<td width="5%">选择</td>
								<td width="10%">序号</td>
