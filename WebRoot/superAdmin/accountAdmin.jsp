...
<title>My JSP 'accountAdmin.jsp' starting page</title>
...
List<ExpertBean> allExpert = adminService.getExperts();
%>
	...
	<table width="98%" border="1" class="maintable">
		<tr>
			...
			<td width="82%" align="center" valign="top">
				<div class="subtitle">辽宁省科学技术协会-账号管理</div>
				<div class="secondtable">
					<table width="98%" border="1" id="inner">
						<thead>
							<th width="5%">选中</th>
							<th width="5%">序号</th>
							<th width="12%">真实姓名</th>
							...
							<th width="16%">最后登录时间</th>
							<th width="9%">登陆次数</th>
							<th width="9%">管理员级别</th>
							<th width="13%">操作</th>
						</thead>
						<form action="JDBCTest" method="get" name="accountAdmin">
							<tr>
								...
								<td>12</td>
								<td>1</td>
								<td><input type="submit" name="edit" id="edit" value="修改" />
									<input type="submit" name="delete" id="delete" value="删除" /></td>
							</tr>
							<tr>
								<td><input type="checkbox" name="checkbox" id="checkbox" /></td>
								<td>2</td>
