<%@page import="com.novae.eswsplatform.bean.ExpertBean"%>
...
<title>My JSP 'firstNumAdmin.jsp' starting page</title>
...
List<ExpertBean> allExperts = adminService.getExperts();
%>
	...
	<table width="98%" border="1" class="maintable">
		<tr>
			...
			<td width="82%" align="center" valign="top">
				<div class="subtitle">辽宁省科学技术协会-初评名额管理</div>
				<div class="secondtable">

					<table width="100%" border="1">
						<tr>
							<td width="10%">序号</td>
							<td width="40%">评审专家组</td>
						...
						<%
							for (int i = 0; i < allExperts.size(); i++) {
								ExpertBean expertBean = allExperts.get(i);
						%>
						<form action="ChangeReferQuota" method="get"
							name="ChangeReferQuota">
							<tr>
								<td><%=expertBean.getId()%></td>
								<td><%=expertBean.getName()%></td>
								<td><%=expertBean.getId()%></td>
								<td><input type="text" name="num" id="num" /></td>
								<td><input name="change" type="button" value="提交" /></td>
							</tr>
						</form>
						<%
							}
