...
<title>My JSP 'commutteeVoteAdmin.jsp' starting page</title>
	...
	<table width="98%" border="1" class="maintable">
		<tr>
			...
			<td width="82%" align="center" valign="top">
				<div class="subtitle">辽宁省科学技术协会-评审委员会投票管理</div>
					...
					<form action="abc" method="get" name="canFirstRtAdmin">
						...
						<table width="95%" border="1"
							...
							<tr>
								...
								<td>123;</td>
								<td>123</td>
								<td><input name="change" type="button" value="从已入选名单移除" /></td>
							</tr>
						</table>
						...
						<table width="95%" border="1" style="float:left">
							...
							<tr>
								...
								<td>123;</td>
								<td>123</td>
								<td><input name="change" type="button" value="加入到已入选名单" /></td>
							</tr>
						</table>
					</form>
				</div>
